                            ...
                            onActiveChanged: {
                                if (active) {
                                    ...
                                    if (root.hoveredWorkspace !== null && root.hoveredWorkspace.workspace !== windowItem.hyprlandClient.workspace.id) {
                                        root.luaDispatch(`hl.dispatch(hl.dsp.window.move({workspace='${root.hoveredWorkspace.workspace}', window='address:${windowItem.hyprlandClient.address}'}))`);
                                    } else {
            ...
            WListView {
                ...
                delegate: TaskViewWorkspace {
                    ...
                    onClicked: {
                        ...
                        root.luaDispatch(`hl.dispatch(hl.dsp.focus({workspace='${workspaceItem.workspace}'}))`);
                    }
                }
            }
        }
