            ...
            sourceComponent: CircleUtilButton {
                ...
                onClicked: event => {
                    if (Appearance.m3colors.darkmode) {
                        root.luaDispatch(`hl.exec_cmd('${Directories.wallpaperSwitchScriptPath} --mode light --noswitch')`);
                    } else {
                        root.luaDispatch(`hl.exec_cmd('${Directories.wallpaperSwitchScriptPath} --mode dark --noswitch')`);
                    }
                }
                MaterialSymbol {
                    horizontalAlignment: Qt.AlignHCenter
